  ...
  (let ((short-prompt "line 1\nline 2\nline 3\nline 4\nline 5")
    ...
    (cl-letf (((symbol-function 'ai-code-read-string)
               (lambda (prompt &optional initial-input candidate-list)
                 (setq ai-code-read-string-called t)
                 "confirmed short"))
              ...
              ((symbol-function 'ai-code--insert-prompt)
               (lambda (prompt)
                 (setq insert-prompt-called prompt))))
      (ai-code--confirm-and-send "Confirm: " short-prompt)
      (should ai-code-read-string-called)
  ...
  (let ((long-prompt "line 1\nline 2\nline 3\nline 4\nline 5\nline 6")
    ...
    (cl-letf (((symbol-function 'ai-code-read-string)
              ...
              ((symbol-function 'ai-code--insert-prompt)
               (lambda (prompt)
                 (setq insert-prompt-called prompt))))
      (ai-code--confirm-and-send "Confirm: " long-prompt)
