...
(defconst eca-ext-test--module-available
  (require 'eca-ext nil t)
  "Non-nil when the optional eca-ext module is available for testing.")

(unless eca-ext-test--module-available
  (ert-deftest eca-ext-test-module-available ()
    "Skip when the optional eca-ext module is unavailable."
    (ert-skip "eca-ext not available in this test environment")))

(when eca-ext-test--module-available
