...
- MCP can provide critical context to AI model. You can use C-c a g to open and add mcp config for corresponding AI coding CLI. Examples MCPs:
  ...
  - [[https://github.com/modelcontextprotocol/servers/tree/main/src/sequentialthinking][Sequential Thinking MCP]]
...
*** Backend Configuration
   ...
   - Claude Code (`[[./ai-code-claude-code.el][ai-code-claude-code.el]]`)
