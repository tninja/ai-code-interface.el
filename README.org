...
*** Backend Configuration
   ...
   When setting the backend programmatically using `ai-code-set-backend`, you can use either lowercase or capitalized symbols (e.g., both `'opencode` and `'Opencode` will work). The function is case-insensitive for convenience.
