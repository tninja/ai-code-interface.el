...
- [[https://github.com/dakra/ghostel][ghostel]] is also supported as an *experimental* native backend infra option.
  ...
  - Compared with vterm and eat, ghostel support in ai-code-interface.el is still experimental and may behave differently in startup flow, shell integration, or buffer naming.
  - To try it:
