...
#+begin_src emacs-lisp
  (use-package ai-code
    ...
    ;; (setq claude-code-ide-infra-terminal-backend 'vterm) ;; for openai codex, github copilot cli, opencode, grok; for claude-code-ide.el and gemini-cli.el, you can check their config
