...
*** Backend Configuration
   ...
   - Gemini CLI (`[[./ai-code-gemini-cli.el][ai-code-gemini-cli.el]]`)
...
*** Gemini CLI response is relative slow, how to improve?

- A: use gemini-3-flash model, it is pretty fast, with good quality (being able to solve leetcode hard problems). You can set the following in your emacs config:
